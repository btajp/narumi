...
extension TranscriptionModelForm {
    // Mirror of ISO_639_1_LANGUAGES in pipeline/src/narumi/transcription_selection.py.
    // The parity test keeps this identifier set aligned; membership does not promise recognition quality.
    static let iso6391Languages = Set("""
        ...
        """.split(whereSeparator: \.isWhitespace).map { String($0) })

    public static func isSupportedLanguage(_ value: String) -> Bool {
        value == "auto" || iso6391Languages.contains(value)
    }
}
