...
class StdioRPC:
        ...
        *,
        ...
        try:
            ...
            while written < len(encoded):
                self._wait(descriptor, selectors.EVENT_WRITE, deadline)
                if not notified and on_sent is not None:
                    on_sent()
                    notified = True
                try:
                    amount = os.write(descriptor, encoded[written : written + 65536])
    ...
    def notify(self, method: str, params: dict[str, Any] | None = None) -> None:
        ...
        self._send(message, self._deadline(None))
    ...
    def call(
        ...
        *,
        ...
        self._send(
            {"id": identifier, "method": method, "params": params}, deadline, on_sent=on_sent
        )
        while True:
    ...
    def wait_for(
        ...
        *,
        ...
        while True:
            ...
            message = (
                self._notifications.popleft() if self._notifications else self._message(deadline)
            )
            if "id" in message:
    ...
    def _message(self, deadline: float) -> dict[str, Any]:
        while True:
            ...
            try:
                ...
                self._wait(descriptor, selectors.EVENT_READ, deadline)
                try:
    ...
    def _terminate(self) -> None:
        with self._lifecycle_lock:
            ...
            try:
                ...
                # Do not reap the leader before its group is gone: retaining its
                # PID also prevents accidental reuse during descendant cleanup.
